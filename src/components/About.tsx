    ...
    <section className="py-24 sm:py-32" id="about">
      <div className="section-shell grid gap-14 xl:grid-cols-[0.86fr_1.14fr] xl:gap-20">
        <div>
          ...
          <p className="mt-7 max-w-xl text-base leading-8 text-stone-400">
            ...
            {capabilities.map((capability, index) => {
              ...
              return (
                <article className="border-b border-white/10 p-5 last:border-b-0 sm:border-b-0 sm:border-r sm:last:border-r-0" key={capability.title}>
                  ...
                  <p className="mt-2 text-xs leading-5 text-stone-500">{capability.topics.join(", ")}</p>
                </article>
              );
            })}
          </div>
        ...
        <article className="relative rounded-[1.65rem] border border-white/10 bg-white/[0.025] p-2 shadow-[0_35px_100px_rgba(0,0,0,0.28)]">
          <div className="relative min-h-[420px] overflow-hidden rounded-[1.25rem] border border-white/[0.05] bg-surface p-6 sm:p-8">
            ...
            <div className="relative flex items-center justify-between gap-4">
              ...
              <span className="hidden font-mono text-[0.65rem] text-stone-600 sm:block">github.com/jaydeepravaliya</span>
            </div>
            ...
            <div className="relative mt-16 max-w-xl sm:mt-20">
              ...
              <div className="mt-7 flex flex-wrap gap-2">
                {["FastAPI", "PostgreSQL", "Celery", "Redis", "JWT", "pytest"].map((technology) => (
                  <span className="rounded-full border border-white/10 bg-white/[0.035] px-3 py-1.5 text-xs font-medium text-stone-300" key={technology}>
                    {technology}
                  </span>
                ))}
              </div>
            ...
            <div className="relative mt-9 w-full rounded-2xl border border-mint/20 bg-[#131815]/90 p-5 font-mono text-xs leading-6 text-stone-400 shadow-2xl sm:absolute sm:right-8 sm:top-14 sm:mt-0 sm:w-64 sm:rotate-2">
            ...
            <div className="relative mt-9 flex items-center gap-2 text-xs font-semibold text-stone-500 sm:absolute sm:bottom-8 sm:right-8 sm:mt-0">
